...
int test_xml_basic() {
    // Note: Based on your current logic, it expects tags to be properly
    // separated.
    const char *input = "<?xml "
                        "version=\"1.0\"?><root><user><name>John</name><id>1</"
                        "id></user></root>";

    // Your logic adds a newline between every tag and calculates spaces
...
int main() {
    ...
    printf("Starting Pretticy Library Tests...\n");
    printf("----------------------------------\n");
